...
1. **Von Neumann architecture**
    - there are 3 buses:
        1. data bus
        2. [control bus](https://github.com/RubberDuckCollector/subject-resources/blob/main/sixth-form/notes/stem/cs/as-and-a-level-ocr/onenote-structure/unit-1/1-computer-componentsPROCESSOR-COMPONENTS.md#control-bus)
        3. address bus
